...
## nvfp4_gemm_w4a16 M=64 (2026-09-03ba/bb)

Same v028 so. card1 spin=1000, card0
spin=2000. timed act=2150/2400 cur=2800
throttle=0.

| op | card | us_bench | M=1 | W8A8 | s8 | LUT |
|---|---|---:|---:|---:|---:|---:|
| folded | 0 | 37.406 | 34.7 | 46 | 75 | 331.6 |
| folded | 1 | 36.761 | 34.7 | 46 | 75 | 331.6 |
| f8scale | 0 | 39.153 | 37.8 | 46 | 75 | 331.6 |
| f8scale | 1 | 39.047 | 37.8 | 46 | 75 | 331.6 |

New M=64 floor 37.1 us both cards.
~1.07x M=1. Under W8A8 46. Act not 2800.

## nvfp4_gemm_w4a16 M=256 (2026-09-03bc/bd)

Same v028 so. spin=512 of M=256.
timed act=2350/2550 cur=2800 throttle=0.
Card0 try1 folded 140.1 discarded.

| op | card | us_bench | M=64 | W8A8 | s8 | LUT |
|---|---|---:|---:|---:|---:|---:|
| folded | 0 | 120.540 | 37.1 | 75 | 128 | 1083 |
| folded | 1 | 115.560 | 37.1 | 75 | 128 | 1083 |
| f8scale | 0 | 116.389 | 37.1 | 75 | 128 | 1083 |
| f8scale | 1 | 114.151 | 37.1 | 75 | 128 | 1083 |
...
## nvfp4_gemm_w4a16 M=1 K=17408 (2026-09-03bg/bh)

Same v028 so. M=64 heat, spin=2000 of
M=1. timed act=2733/2750 cur=2800
throttle=1.

| op | card | us_bench | square | s8 | W8A8 | s4 |
|---|---|---:|---:|---:|---:|---:|
| folded | 0 | 101.909 | 34.7 | 261.6 | 155.3 | 53.4 |
| folded | 1 | 101.270 | 34.7 | 261.6 | 155.3 | 53.4 |
| f8scale | 0 | 97.361 | 34.7 | 261.6 | 155.3 | 53.4 |
| f8scale | 1 | 97.931 | 34.7 | 261.6 | 155.3 | 53.4 |

New wide-K floor 101 us both cards.
~2.92x square. Beats s8 261.6. Qwen FFN
w4a16 decode map closed. Throttle=1.

## nvfp4_gemm_w4a16 M=64 N=17408 (2026-09-03bi/bj)

Same v028 so. spin=512 of M=64. timed
act=2050/2300 cur=2800 throttle=0.

| op | card | us_bench | square | s8 | s4 | napkin |
|---|---|---:|---:|---:|---:|---:|
| folded | 0 | 144.451 | 37.1 | 338.9 | 94.7 | 104 |
| folded | 1 | 138.903 | 37.1 | 338.9 | 94.7 | 104 |
| f8scale | 0 | 141.560 | 37.1 | 338.9 | 94.7 | 104 |
| f8scale | 1 | 138.595 | 37.1 | 338.9 | 94.7 | 104 |

New wide-N floor 142 us both cards.
~3.82x square. Beats s8 338.9. Loses to
s4 94.7. Spread ~4.0%. Act not 2800.

## nvfp4_gemm_w4a16 M=64 K=17408 (2026-09-03bk/bl)
...
| op | card | us_bench | square | s8 | s4 | napkin |
|---|---|---:|---:|---:|---:|---:|
| folded | 0 | 132.966 | 37.1 | 374.7 | 106.0 | 108 |
| folded | 1 | 127.793 | 37.1 | 374.7 | 106.0 | 108 |
| f8scale | 0 | 139.400 | 37.1 | 374.7 | 106.0 | 108 |
| f8scale | 1 | 129.001 | 37.1 | 374.7 | 106.0 | 108 |

New wide-K floor 130 us both cards.
~3.51x square. ~K-linear. Beats s8 374.7.
...
| phase | shape | c0 us | c1 us | cosine | max_abs | ok |
|---|---|---:|---:|---:|---:|---:|
| check | 8x16x128 | 36.339 | 33.766 | 1.000 | 7.6e-6 | 1 |
| tile | 8x256x256 | 27.990 | 25.974 | 1.000 | 0 | 1 |

Numeric closed both cards (2026-09-03cn).
Do not rank us.

## GPTQ s4 RC=4 decode both cards (2026-09-03ct)
...
|---|---|---:|---:|---:|---:|---:|
| 1 x 5120 | 0 | 29.424 | 29.955 | 16.5 | 34 | 44 |
| 1 x 5120 | 1 | 29.448 | 29.850 | 16.5 | 34 | 44 |
| 4 x 5120 | 0 | 29.404 | 29.899 | 16.5 | 34 | 44 |
| 4 x 5120 | 1 | 29.417 | 29.890 | 16.5 | 34 | 44 |

New floor 29.9 us both cards. ~1.81x
...
## GPTQ s4 RC=4 K=17408 both cards (2026-09-03dc)
...
| 1 x 5120 x 17408 | 1 | 173.448 | 174.509 | 29.9 | 53.4 | 261.6 |
| 4 x 5120 x 17408 | 0 | 174.047 | 174.561 | 29.9 | 53.4 | 261.6 |
| 4 x 5120 x 17408 | 1 | 173.550 | 174.251 | 29.9 | 53.4 | 261.6 |

New floor 174.6 us both cards.
~5.84x square. Spread ~0.07%. Beats
s8 261.6. Loses to s4 53.4 and W8A8
