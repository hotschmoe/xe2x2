...
Next: split. card0: s8xs4 4x8 A-db
M=64 N=17408 (runner
kernels/esimd_dpas/run_s8xs4_db48_wide.sh).
card1: s8xs4 4x8 A-db M=64 K=17408
(runner
...
1. mix 4x8 M=64 N=17408 (square 43.3,
   s4 94.7, W8A8 202, napkin ~147).
2. mix 4x8 M=64 K=17408 (s4 106.0,
   W8A8 181, napkin ~147).
