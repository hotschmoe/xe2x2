#!/usr/bin/env bash
# Held-clock GPTQ s4 RC=4 8x2-N, M=256 N=K=5120.
...
OUT="$ROOT/results/k6/gptq_s4sc_m256_n${NT}_s${SPIN}_card${CARD}.txt"
FREQ="$ROOT/results/k6/gptq_s4sc_m256_n${NT}_s${SPIN}_card${CARD}.freq"
