...
OUT="$ROOT/results/k2/s4sc_n17408_n${NT}_s${SPIN}_card${CARD}.txt"
FREQ="$ROOT/results/k2/s4sc_n17408_n${NT}_s${SPIN}_card${CARD}.freq"
...
trap cleanup EXIT
{
  ...
  echo "CONFIG backend=sycl+l0 card=$CARD arm=dpas_s4_sc nt=$NT spin=$SPIN heat=none out=f16 pack=s4 n=17408"
  echo "s4 M=1 N=5120 is 16.5 us. Napkin N-linear 16.5*17408/5120 ~56 us."
