#!/usr/bin/env bash
# CPU-only AOT for extra K2 TUs. No --device. No gpu-run.
# Usage: ./compile_extra.sh dpas_s8_clk.cpp dpas_s8_d32.cpp
set -euo pipefail
...
SRCS="$*"
mkdir -p "${ROOT}/kernels/esimd_dpas/bin" "${ROOT}/results/k2"
