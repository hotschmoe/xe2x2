#!/usr/bin/env python3
"""Held-clock oneDNN nvfp4_gemm_w4a16, M=1 5120. pytorch-xpu on sycl+l0.

M=64 heat for JIT, then M=1 spin, then timed M=1. Rank pipe_host vs
unheld ~37 us. A is bf16, not s8. No E2M1 cosine this dump.
"""
...
def main() -> int:
    ...
    print(
        ...
        f"heat=M64 spin={spin} time=M1 n=5120 k=5120",
        flush=True,
    )
