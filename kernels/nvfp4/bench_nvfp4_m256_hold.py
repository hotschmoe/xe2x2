#!/usr/bin/env python3
"""Held-clock oneDNN nvfp4_gemm_w4a16, M=256 5120. pytorch-xpu on sycl+l0.

Spin M=256 then timed M=256 at named 2800. A is bf16, not s8. No E2M1 cosine.
Rank us_bench vs W8A8 75, s8 128, compose 194.9, LUT 1083.
"""
