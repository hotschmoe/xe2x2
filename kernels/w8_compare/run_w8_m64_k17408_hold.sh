#!/usr/bin/env bash
# Held-clock oneDNN int8_gemm_w8a8 M=64 N=5120 K=17408.
...
OUT="$ROOT/results/k2/w8a8_m64_k17408_hold_card${CARD}.txt"
FREQ="$ROOT/results/k2/w8a8_m64_k17408_hold_card${CARD}.freq"
